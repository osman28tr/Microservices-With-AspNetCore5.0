...
namespace FreeCourse.IdentityServer.Services
{
    ...
    {
        public string GrantType => "urn:ietf:params:grant-type:token-exchange";
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            var subjectClaim = tokenValidateResult.Claims.FirstOrDefault(c => c.Type == "sub"); //resourceowner grant type kontrolü
